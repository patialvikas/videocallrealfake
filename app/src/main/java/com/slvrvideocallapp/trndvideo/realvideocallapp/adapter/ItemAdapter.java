...
public class ItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ItemAdapter(Activity activity, Context context, List<CatItem> dataList,
...
//        return new MyViewHolder(itemView);
        ...
        switch (viewType) {
            case 0: {
                View v0 = inflater.inflate(R.layout.layout_item_view, parent, false);
                viewHolder = new ItemViewHolder(v0);
                break;
            }
            case 1: {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)){
            case 0:
                final ItemViewHolder holderd = (ItemViewHolder) holder;
                CatItem catItem = dataList.get(position);

                if (catItem.getItemId()!=null) {

                    holderd.item_name_txt.setText(catItem.getItemName());

                    final int random1 = new Random().nextInt(9) + 1;
                    final int random2 = new Random().nextInt(9) + 1;
                    String coinNum = String.valueOf(random1)+"."+String.valueOf(random2)+"k";
                    holderd.coin_num_txt.setText(coinNum);



                    Glide.with(context)
                            .load(catItem.getItemIv())
        //                        .skipMemoryCache(true)
                            .apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.RESOURCE)
                                    .placeholder(new ColorDrawable(context.getResources().getColor(R.color.yellow))).centerCrop())
                            .into(holderd.item_image);

                    holderd.itemView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            listener.onItemClick(position,catItem,v);
                        }
                    });
    ...
    public interface OnItemClickListener {
        void onItemClick(int postion, CatItem item, View view);
    }
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView coin_num_txt,item_name_txt;
        ...
        public ItemViewHolder(View view) {
            ...
            coin_num_txt = view.findViewById(R.id.coin_num_txt);
            item_name_txt = view.findViewById(R.id.item_name_txt);
    ...
    public class AdmobNativeHolder extends ItemViewHolder {
            ...
            builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
                ...
                public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                    ...
                    UnifiedNativeAdView adView = (UnifiedNativeAdView) activity.getLayoutInflater()
                            .inflate(R.layout.ad_unified_gridrcycl, null);
