...
public class DStartActivityyyy extends AppCompatActivity {
    ImageView ivLiveCall,ivRandomCall;
...
//    private static final String TAG = DisplayUserActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dactivity_startttt);
        ivLiveCall=findViewById(R.id.ivLiveCall);
        ivRandomCall=findViewById(R.id.ivRandomCall);
        ...
        newreleasenative(DStartActivityyyy.this);
        ivLiveCall.setOnClickListener(new View.OnClickListener() {
            @Override
                            ...
                            if (mInterstitialAdr.isLoaded()) {
                                ...
                                mInterstitialAdr.setAdListener(new com.google.android.gms.ads.AdListener() {
                                    ...
                                    public void onAdClosed() {
                                        ...
                                        startActivity(new Intent(DStartActivityyyy.this, RoomListActivity.class));
                                    }
                                });
                            } else {
                                startActivity(new Intent(DStartActivityyyy.this, RoomListActivity.class));
        ...
        ivRandomCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent;
                if(prf.getString("realvideocall").equalsIgnoreCase("1")) {
                    intent=new Intent(context, HomeCategoryActivity.class);
                } else {
        ...
        ImageView privacypolicy = (ImageView) findViewById(R.id.privacypolicy);
...
//                        addtorrents.setVisibility(View.VISIBLE);
    ...
    public void bckpressed() {
        startActivity(new Intent(DStartActivityyyy.this, DExitActivityyy.class));
    }
}