...
//    private static final String TAG = DisplayUserActivity.class.getSimpleName();
    ...
    public RoomListAdapter(int listCount, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        listItem = layoutInflater.inflate(R.layout.item_room, parent, false);
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull @NotNull RecyclerView.ViewHolder holdermain) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull RecyclerView.ViewHolder holdermain, int position) {
        ViewHolder holder = (ViewHolder) holdermain;
        holder.txtName.setText("Room "+(position+1));
        holder.txtTitle.setText("" + titleList[rand.nextInt(titleList.length)]);
        holder.txtCountry.setText("" + countryList[rand.nextInt(countryList.length)]);
...
//        }
    ...
    private void startNextActivity() {
        if(prf.getString("realvideocall").equalsIgnoreCase("1")) {
            ...
            intent.putExtra("country_iv"," http://sameer1.myappadmin.xyz/condell/images/e0079216089f03035a0d23224d16bb87.jpg");
